      ...
      <div className="card">
        {Array.from({ length: 10 }).map((_, i) => (
          <div key={i} className="flex gap-4 px-4 py-3 border-b" style={{ borderColor: "var(--border)" }}>
            <div className="h-4 w-36 rounded animate-pulse" style={{ background: "var(--border)" }} />
            <div className="h-4 w-24 rounded animate-pulse ml-auto" style={{ background: "var(--border)" }} />
